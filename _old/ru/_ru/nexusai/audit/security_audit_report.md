...
| R-06 | ML results are on synthetic data | Medium (for the claims, not the contracts) | Stated in the ML report and the model card. Real-corpus loaders are written and attempted first |
...
forge an attestation, or bypass the quality gate in the code I reviewed. I
cannot say there is nothing there.
